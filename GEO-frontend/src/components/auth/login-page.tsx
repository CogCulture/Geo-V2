  ...
  return (
    <div className="min-h-[calc(100vh-80px)] w-full flex flex-col items-center justify-center bg-gray-50/50 p-4">
      <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
        ...
        <Button 
          variant="outline" 
          className="w-full h-12 text-base font-normal text-gray-700 border-gray-200 hover:bg-gray-50 hover:text-gray-900 flex items-center gap-2 mb-6"
          type="button"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button 
            type="submit" 
            className="w-full h-12 text-base font-medium bg-[#1a1f2e] hover:bg-black text-white mt-2 rounded-lg"
          >
            Sign In
          </Button>
        </form>
      ...
      <div className="mt-8 text-center space-y-2">
        <p className="text-xs text-gray-400">
          By continuing, you agree to our <a href="#" className="hover:text-gray-600">Terms of Service</a> and <a href="#" className="hover:text-gray-600">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
